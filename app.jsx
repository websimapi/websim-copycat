...
function SplashScreen({ onDismiss }) {
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: `splash-screen ${isHiding ? "hidden" : ""}`, onClick: handleClick, children: [
    /* @__PURE__ */ jsxDEV("img", { src: "logo.png", alt: "Copycat Logo", className: "splash-logo" }, void 0, false, {
      fileName: "<stdin>",
      lineNumber: 45,
      columnNumber: 13
    }, this),
    /* @__PURE__ */ jsxDEV("p", { className: "splash-text", children: "Tap to start" }, void 0, false, {
      fileName: "<stdin>",
      lineNumber: 46,
      columnNumber: 13
    }, this)
...
- You MUST combine multiple snippets if it makes the response better. A good response often uses 2-4 snippets.
...
Try again. Be more creative this time. You MUST combine different snippets to form a new phrase that responds well to the user's original message.
...
Respond ONLY with a JSON object containing a 'selected_ids' key (an array of snippet IDs). If you still can't find anything, return an empty array.`;
  ...
  if (isSplashVisible) {
    return /* @__PURE__ */ jsxDEV(SplashScreen, { onDismiss: () => setIsSplashVisible(false) }, void 0, false, {
      fileName: "<stdin>",
      lineNumber: 340,
      columnNumber: 16
    }, this);
