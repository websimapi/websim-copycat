...
function ChatMessageContent({ text }) {
  ...
  if (!needsTruncation) return /* @__PURE__ */ jsxDEV(Fragment, { children: text }, void 0, false, {
    fileName: "<stdin>",
    lineNumber: 6,
    columnNumber: 32
  }, this);
  return /* @__PURE__ */ jsxDEV("div", { onClick: () => setIsExpanded((p) => !p), className: "cursor-pointer", children: isExpanded ? /* @__PURE__ */ jsxDEV(Fragment, { children: [
    text,
